...
- Pour générer les données, exécuter le notebook [notebooks/DataGeneration.ipynb](https://github.com/dataesr/bso-clinical-trials/blob/main/notebooks/DataGeneration.ipynb) complet.
- Les outputs sont alors dans le dossier publipostage (non commité).
- Pour exclure un promoteur, ajouter son ROR à la liste "excluded_rors" dans la seconde cellule du notebook [notebooks/DataGeneration.ipynb](https://github.com/dataesr/bso-clinical-trials/blob/main/notebooks/DataGeneration.ipynb).
